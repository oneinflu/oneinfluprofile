...
export default function WelcomeClient({ fontClassName }: { fontClassName?: string }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20">
            ...
            <div className="relative h-[400px] w-full overflow-hidden lg:h-[500px]">
                {mounted && (
                    <div className="absolute top-6 right-6 z-50">
                        <Button
                            size="md"
                            className="rounded-full bg-white/10 backdrop-blur-md border-white/20 text-white hover:bg-white/20 shadow-lg"
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center p-6 lg:p-12">
                    ...
                    >
                        <p className={cx("mb-2 text-4xl text-white drop-shadow-lg md:text-5xl lg:text-6xl", fontClassName)}>
                            You have been Invited
                        </p>
                        
                        <div className="my-4 h-px w-24 bg-white/30 mx-auto justify-center" />

                        
                        <h1 className="text-display-md font-bold text-white md:text-display-lg drop-shadow-md">
                            {event.eventName}
                        </h1>
                        <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-white/90">
                            <div className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
                                ...
                                <span className="font-medium">
                                    {event.date ? new Date(event.date).toLocaleDateString("en-IN", { weekday: "long", day: "numeric", month: "long", year: "numeric" }) : "Date TBA"}
                                </span>
                            </div>
                            <div className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
            ...
            <div className="mx-auto max-w-2xl px-4 -mt-12 relative z-10 space-y-6">
                ...
                <motion.div 
                    ...
                    className="overflow-hidden rounded-2xl bg-white shadow-lg dark:bg-gray-900 ring-1 ring-gray-200 dark:ring-gray-800"
                >
                    <div className="border-b border-gray-200 bg-gray-50 px-6 py-4 dark:border-gray-800 dark:bg-gray-800/50 text-center">
                        <h2 className="text-sm font-semibold uppercase tracking-wider text-tertiary">Invitation Code</h2>
                    </div>
                    <div className="p-8 text-center">
                        <div className="mb-2 text-display-lg font-mono font-bold tracking-widest text-brand-solid">
                            INFLU87
                        </div>
                        <p className="text-sm text-tertiary">Present this code after scanning QR</p>
                    </div>
                </motion.div>
